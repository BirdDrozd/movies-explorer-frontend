...
export const phrases = {
    ...
    altUnSuccess: 'При регистрации произошла ошибка',
    editProfileSuccess: 'Вы успешно отредактировали профиль!',
    editProfileUnSuccess: 'Что-то пошло не так! Попробуйте ещё раз.',
    altProfileSuccess: 'Обновление профиля прошло успешно',
    altProfileUnSuccess: 'При обновлении профиля произошла ошибка',
}
