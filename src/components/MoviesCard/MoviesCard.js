...
import savedButtonLogo from "../../images/Button-Saved-Movie.svg";
import unSavedButtonLogo from "../../images/Button-Unsaved-Movie.svg";
import deleteMovieLogo from "../../images/Button-delete-card.svg";
    ...
    return (
        <li className="movies-card">
            <div className="movies-card__header-wrapper">
                ...
                <button className="movies-card__save-button" onClick={onButton} aria-label="кнопка сохранения и удаления фильма" type="button">
