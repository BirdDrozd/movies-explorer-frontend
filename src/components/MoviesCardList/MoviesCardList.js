...
function MoviesCardList({ savedMovies, movies, deleteMovie, saveMovie, queryMovies,
    ...
    return (
        <section className="movies">
            ...
            {queryMovies.length > roundedVisibleCardCount && <button className="movies__load-more-button" type="button" onClick={handleClick} aria-label="загрузить больше фильмов">Ещё</button>}
        </section>
    )
}
